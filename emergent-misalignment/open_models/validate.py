...
class TrainingConfig(BaseModel):
    ...
    train_lib: str = Field(..., description="unsloth or peft")
    ...
    response_part_mode: Optional[str] = Field(None, description="Specify tokenwise otherwise leave blank")
    ...
    save_steps: Optional[int] = Field(None, description="Save checkpoint every X steps")
