...
## Training
Before you train, you need to set `finetuned_model_id` in [train.json](configs/train.json) to a model id under a huggingface namespace that you can push to. Then, run:
```
